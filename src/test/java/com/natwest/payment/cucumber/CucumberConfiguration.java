...
import com.natwest.payment.PaymentsAppApp;
import com.natwest.payment.cucumber.CucumberConfiguration.CucumberRestTemplateConfiguration;

@CucumberContextConfiguration
@SpringBootTest(classes = { PaymentsAppApp.class, CucumberRestTemplateConfiguration.class }, webEnvironment = WebEnvironment.RANDOM_PORT)

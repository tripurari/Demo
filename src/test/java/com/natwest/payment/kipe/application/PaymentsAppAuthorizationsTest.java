...
import static com.natwest.payment.kipe.application.TestAuthentications.*;
import static com.natwest.payment.kipe.domain.RolesAccessesFixture.*;
...
import com.natwest.payment.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class PaymentsAppAuthorizationsTest {

  private static final PaymentsAppAuthorizations authorizations = new PaymentsAppAuthorizations(List.of(rolesAccesses()));
